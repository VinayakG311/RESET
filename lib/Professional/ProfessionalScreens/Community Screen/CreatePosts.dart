            ...
            RoundedButton(Colors.white, "Post",
                    () async {
                       ...
                       if(link!="err") {
                         ...
                         Posts posts = Posts(img: link,
                             uploadedby: widget.model.firstname,
                             likes: 0,
                             caption: caption,
                             uid: new Uuid().v1(),
                             bookmarks: 0);
                         await FirebaseFirestore.instance.collection(
                             "Professional").doc(widget.model.uid).collection(
                             "posts").doc(posts.uid).set(posts.toMap());
                         await FirebaseFirestore.instance.collection(
                             "Posts").doc(posts.uid).set(posts.toMap());
                         // Navigator.of(context).push(MaterialPageRoute(
                         //     builder: (context) =>
                         //         Community(model: widget.model)));
                       };
                    }, Colors.black),
      //      ],
          ],
