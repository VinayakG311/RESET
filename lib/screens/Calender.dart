...
import 'package:reset/screens/Calender%20Screen/AddTask.dart';
...
class Calender extends StatefulWidget {
  Calender({Key? key, this.userModel, this.firebaseuser}) : super(key: key);
        ...
        children: [
          Row(
            children: [
              ...
              isdone==false?Text(widget.model.title!):Text(widget.model.title!,style: TextStyle(decoration: TextDecoration.lineThrough),),
