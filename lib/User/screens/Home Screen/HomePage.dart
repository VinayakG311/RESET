...
import 'PostPage.dart';
  ...
  class HomePage extends StatelessWidget {
    ...
    const HomePage({Key? key, this.firebaseUser, this.userModel}) : super(key: key);
    @override
          ...
          children: [
            Row(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(widget.posts.uploadedby!,style: const TextStyle(fontWeight: FontWeight.bold),),
                ),
                InkWell(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                      child: isbookmarked==false?const Icon(Icons.bookmark_border_outlined):const Icon(Icons.bookmark,color: Colors.black,),
                  onTap:() async {
                    setState(()  {
